...
const BannerMovieSkeleton = () => {
  return (
    <div>
      ...
      >
        <div className="h-[552px] w-full bg-gray-600 animate-pulse"></div>
      </div>
      <ul className="flex justify-evenly items-center mt-1">
        <li className="flex items-center gap-2 py-2 flex-col">
          <AiOutlinePlus size={20} />
          <div className="h-5 w-7 bg-gray-600 animate-pulse rounded"></div>
        </li>
        <li className="flex items-center gap-2 w-[88px] h-9 bg-gray-600 animate-pulse rounded"></li>
        <li className="flex items-center gap-2 py-2 flex-col">
      ...
      <ul className="flex items-center justify-evenly text-sm font-semibold mt-3 mb-16">
        <li className="h-[30px] w-[171px] bg-gray-600 animate-pulse rounded"></li>
        <li className="h-8 w-[60px] bg-gray-600 animate-pulse rounded"></li>
        <li className="h-8 w-[67px] bg-gray-600 animate-pulse rounded"></li>
      </ul>
    </div>
  );
};
